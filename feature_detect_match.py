...
if __name__ == '__main__':
    ...
    img_1_ = dilate(img_1, L=6)
    img_1_de = erode(img_1_, L=1)
    img_1_ct = find_contour(img1=img_1_, img2=dilate(img=img_1, L=4))
    ...
    img_2_ = dilate(img_2, L=6)
    img_2_de = erode(img_2_, L=1)
    img_2_ct = find_contour(img1=img_2_, img2=dilate(img=img_2, L=4))
